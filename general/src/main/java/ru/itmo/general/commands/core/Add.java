...
//     *
//     * @param routeCollectionManager менеджер коллекции
//     * @param routeForm форма для создания объектов Route
//     */
//    public Add(CollectionManager<Route> routeCollectionManager, Form<Route> routeForm) {
//        this();
//        this.routeCollectionManager = routeCollectionManager;
//        this.routeForm = routeForm;
//    }
...
//            var route = ((Route) request.getData());
//            if (!route.validate()) {
//                return new Response(false, "Маршрут не добавлен, поля маршрута не валидны!");
//            }
//            route.setUserId(request.getUserId());
//            Integer newID = routeCollectionManager.add(route, request.getUserId());
//            if (newID == -1)
//                return new Response(false, "Маршрут уже существует", -1);
//            return new Response(true, "Маршрут успешно добавлен", newID);
//        } catch (Exception e) {
//            return new Response(false, e.toString(), -1);
//        }
//    }
...
//            return new Request(false, getName(), getUsingError());
//        } catch (InvalidFormException exception) {
//            return new Request(false, getName(), "Поля маршрута не валидны! Маршрут не создан!");
//        } catch (InvalidScriptInputException ignored) {
//            return new Request(false, getName(), "Ошибка чтения из скрипта");
//        }
//    }
